...
### Fixed
- **Device Capabilities** - Improved capability detection from supportAttributes and implied attributes
- **Capability Merging** - Expand capabilities, never shrink (preserves device functionality over time)

## [1.0.14] - 2025-09-01

### Fixed
- **MQTT Listener SSL** - Use relaxed certificate validation (like Sengled bulbs do)
- **Connection Loop** - Eliminated infinite retry loop by using bulb-compatible SSL mode
